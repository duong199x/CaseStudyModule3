                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Thông Tin Đơn Hàng</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                <form action="/admin?action=changeStatus&id=${order.id}" method="post">
                                    <tr>
                                        <td>${order.time}</td>
                                        <td>${order.total}</td>
                                        ...
                                        <td>
                                            <select name="status" class="form-select form-control">
                                                <option <c:if test="${order.status == 1}"> selected</c:if> value="1">Chưa Xác Nhận</option>
                                                <option <c:if test="${order.status == 2}"> selected</c:if> value="2">Đã Xác Nhận</option>
                                                <option <c:if test="${order.status == 3}"> selected</c:if> value="3">Chưa Giao Hàng</option>
                                                <option <c:if test="${order.status == 4}"> selected</c:if> value="4">Đã Giao Hàng</option>
                                            </select>
                                        </td>
                                        <td> <button class="btn bg-gradient-success" type="submit">Thay đổi</button></td>
                                    </tr>
                                </form>
                                </tbody>
                            </table>
