...
<head>
    ...
    <title>Sửa Thông Tin Sản Phẩm -WS </title>
    <!--     Fonts and icons     -->
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="../css/admin/editProduct.css"/>">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Sửa Thông Tin</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Sửa Thông Tin Sản Phẩm</h6>
                </nav>
            </div>
        </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Sửa Thông Tin Sản Phẩm</h6>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <form action="http://localhost:8080/admin/product?action=edit&id=${id}" method="post">
                                        ...
                                        <tr>
                                            <th>Giá</th>
                                            <th><input type="text" name="price" value="${editProduct.price}"></th>
                                        </tr>
                                        <tr>
                                            <th>Tình Trạng</th>
                                            <th>
                                                <select name="status">
                                                    <c:choose>
                                                        <c:when test="${editProduct.status == true}">
                                                            <option value="<c:out value="${editProduct.status}"/>">Còn
                                                                hàng
                                                            </option>
                                                        </c:when>
                                                        <c:when test="${editProduct.status == false}">
                                                            <option value="<c:out value="${editProduct.status}"/>">Hết
                                                                hàng
                                                            </option>
                                                        </c:when>
                                                    </c:choose>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Sửa Thông Tin Size Sản Phẩm</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                ...
                <div class="col-8">
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Sửa Thông Tin Ảnh Sản Phẩm</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        ...
                        <div class="col-lg-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://www.creative-tim.com" class="nav-link text-muted" target="_blank">WindowShop
                                        </a>
                                </li>
                                <li class="nav-item">
