...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="../css/admin/creatProduct.css"/>">
</head>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary " href="http://localhost:8080/admin/product?action=create">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="http://localhost:8080/admin/product?action=admin">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Thêm Mói SP</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Thêm Mới Sản Phẩm</h6>
            </nav>
        </div>
    </nav>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Thêm Sản Phẩm Mới</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Các
                                        Thuộc Tính
                                    </th>
                                ...
                                <form action="http://localhost:8080/admin/product?action=create" method="post">
                                    ...
                                    <tr>
                                        <th>Mô Tả</th>
                                        <th><textarea type="text" name="description"></textarea></th>
                                    </tr>
                                    <tr>
                                        <th>Hãng</th>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">WindowShop
                                </a>
                            for a better web.
                        </div>
                    </div>
